...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sc) => sc.setName('achievement')
      ...
      .addStringOption((o) => o.setName('id').setDescription('ID achievement (0 = disattiva).').setRequired(true).setMaxLength(100)))
    ...
    .addSubcommand((sc) => sc.setName('schedule')
      ...
      .addStringOption((o) => o.setName('giorni').setDescription('Giorni raid (es: 3,4 = Mer,Gio). 0=Dom, 1=Lun, 2=Mar, 3=Mer, 4=Gio, 5=Ven, 6=Sab').setRequired(true).setMaxLength(100))
      .addStringOption((o) => o.setName('orario').setDescription('Orario raid (es: 21:00).').setRequired(false).setMaxLength(100))
      .addStringOption((o) => o.setName('nome').setDescription('Nome raid (es: Manaforgia Omega).').setRequired(false).setMaxLength(200)))
