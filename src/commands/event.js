...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sc) => sc.setName('create')
      ...
      .addStringOption((o) => o.setName('nome').setDescription('Nome evento.').setRequired(true))
      .addStringOption((o) => o.setName('quando').setDescription('Data/ora (es. 2026-07-25 20:00).').setRequired(true))
      .addIntegerOption((o) => o.setName('durata').setDescription('Durata in minuti.').setRequired(false))
      .addStringOption((o) => o.setName('gioco').setDescription('Codice gioco (es. valorant).').setRequired(false).setAutocomplete(true))
      .addStringOption((o) => o.setName('descrizione').setDescription('Descrizione evento.').setRequired(false)))
