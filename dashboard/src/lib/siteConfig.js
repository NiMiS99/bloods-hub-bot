...
export const siteConfig = {
  guildName: 'Bloods',
  tagline: 'Multigioco IT · WoW Midnight · DayZ · Metin2 · LoL',
  description:
    'Bloods Community — multigioco italiano con base WoW su Pozzo dell\'Eternità EU (Orda). Midnight Season 2, raid Mer+Gio, M+, PvP, DayZ, Metin2, LoL. 150 membri, 80+ attivi. Famiglia + progress.',
